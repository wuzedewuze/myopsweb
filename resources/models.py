...
class Server(models.Model):
    ...
    service_id = models.IntegerField("业务线",db_index=True, null=True)
    server_purpose = models.IntegerField("服务信息",db_index=True, null=True)
    check_update_time = models.DateTimeField("最后检查时间",auto_now=True, null=True)
